...
export const scaleRanges = [
  { id: 'all', name: '全部', min: 0, max: Infinity },
  { id: 'small', name: '10亿以下', min: 0, max: 10 },
...
export const sortOptions = [
  { id: 'default', name: '默认', field: null, order: null },
  { id: 'dayChangeDesc', name: '日涨跌↓', field: 'dayChange', order: 'desc' },
  { id: 'dayChangeAsc', name: '日涨跌↑', field: 'dayChange', order: 'asc' },
  { id: 'yearChangeDesc', name: '近一年↓', field: 'yearChange', order: 'desc' },
  { id: 'yearChangeAsc', name: '近一年↑', field: 'yearChange', order: 'asc' },
  { id: 'navDesc', name: '单位净值↓', field: 'nav', order: 'desc' },
  { id: 'navAsc', name: '单位净值↑', field: 'nav', order: 'asc' },
];
